...
#Open trace file
set f [open $rtt-$loss_rate-$bandwidth-$object-littlecwnd.trace w]
$ns trace-all $f

set pf [open $rtt-$loss_rate-$bandwidth-$object-littlecwnd.trace w]
...
set TCPtraceFile [open $rtt-$loss_rate-$bandwidth-$object-littlecwnd.tr w]
...
############################################
#$tcp set windowInit_ 128	#设定起始窗口为200*MSS
